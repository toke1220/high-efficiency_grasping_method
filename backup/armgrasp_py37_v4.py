...
config = rs.config()
config.enable_stream(rs.stream.depth, 1280, 720, rs.format.z16, 30) #848*480
...
def bbox_yolov3(testImg):
    ...
    # datacfg = '/home/mi/projects/darknet/cfg/my_laji.data'
    # cfgfile = '/home/mi/projects/darknet/cfg/yolov3_trash.cfg'
    # weightfile = '/home/mi/projects/darknet/yolov3_16000_800_mul_800pixels.weights'
