...
def bbox_yolov4(testImg):
    ...
    for i, det in enumerate(dets):   #会有多个bbox
        ...
        f1 = (dets[i][2] - 1.1*dets[i][2]) / 2
        f2 = (dets[i][3] - 1.1*dets[i][3]) / 2

        dets[i][2] = 1.1*dets[i][2] #w     框缩小
        dets[i][3] = 1.1*dets[i][3] #hds
...
if __name__ == '__main__':
    ...
    testImg = '/home/toke/Desktop/image/camera_catch.png'
    #testImg = '/home/toke/Desktop/image/2.jpg'
